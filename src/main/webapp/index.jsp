        ...
        <th class="choose-area">
            ...
            <form id="coordinates-form" method="post" action="main">
                <div class="checkbox-area">
                    ...
                    <p>Выберите R:</p>
                    <div class="r">
                        <label>1<input type="checkbox" name="r" id="cb1" value="1" onclick="controlCheckbox(this)"
                                       checked></label>
                        <label>2<input type="checkbox" name="r" id="cb2" value="2"
                                       onclick="controlCheckbox(this)"></label>
                        <label>3<input type="checkbox" name="r" id="cb3" value="3"
                                       onclick="controlCheckbox(this)"></label>
                        <label>4<input type="checkbox" name="r" id="cb4" value="4"
                                       onclick="controlCheckbox(this)"></label>
                        <label>5<input type="checkbox" name="r" id="cb5" value="5"
                                       onclick="controlCheckbox(this)"></label>
                    </div>
